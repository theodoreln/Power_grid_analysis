...
lnd.LoadNetworkData(filename['Nordic']) # makes Ybus available as lnd.Ybus etc.
...
V,success,n = pf.PowerFlowNewton(lnd.Ybus,lnd.Sbus,lnd.V0,lnd.pv_index,lnd.pq_index,max_iter,err_tol,1)
